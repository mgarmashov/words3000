<nav class="navbar navbar-expand-lg navbar-light bg-light"><a class="navbar-brand" href="{{ route('welcome') }}">3000 Words</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="nav-item active">
            {{--<ul class="navbar-nav mr-auto"><a class="nav-link" href="{{ route('registration') }}">Регистрация</a></ul>--}}
        </div>
    </div>
</nav>