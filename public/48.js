...
Component.options.__file = "resources/assets/admin/js/views/icons/Material.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-88adf562", Component.options)
  } else {
    hotAPI.reload("data-v-88adf562", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-88adf562", module.exports)
  }
}
