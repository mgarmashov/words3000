...
Component.options.__file = "resources/assets/admin/js/views/users/UsersList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-39c119bc", Component.options)
  } else {
    hotAPI.reload("data-v-39c119bc", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-39c119bc", module.exports)
  }
}
