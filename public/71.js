...
Component.options.__file = "resources/assets/admin/js/views/session/LockScreen.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f2f17e3", Component.options)
  } else {
    hotAPI.reload("data-v-2f2f17e3", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2f2f17e3", module.exports)
  }
}
